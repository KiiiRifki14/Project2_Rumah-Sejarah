        ...
        <div class="col-md-5">
            <div class="glass-card text-center">
                <div style="width:70px;height:70px;border-radius:50%;background:rgba(212,168,67,0.15);display:flex;align-items:center;justify-content:center;margin:0 auto 1.5rem;">
                    <i class="fas fa-user-shield" style="font-size:1.8rem;color:var(--gold);"></i>
                </div>
                <h3 style="font-weight:800;">Login Admin</h3>
                <p style="color:var(--text-secondary);margin-bottom:2rem;">Masuk ke panel admin</p>
                ...
                <form action="{{ route('admin.login.submit') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-gold w-100"><i class="fas fa-sign-in-alt me-2"></i>Masuk</button>
                </form>
            </div>
        </div>
    </div>
